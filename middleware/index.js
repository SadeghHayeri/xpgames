            ...
            if(!req.user.verifyToken)
            {
                ...
                var mailOptions = {
                    ...
                    html: ejs.render("<html lang='fa'>" +
                        " <body><div  style='text-align: right'> سلام  <br>: ثبت نامت با موفقیت انجام شد  <br>: برای تایید ایمیلت رو لینک زیر کلیک کن  <br></div> http://<%=host%>/verify/<%=token%></body>" ,{host:req.headers.host,token:verifyToken})// html body
                };
